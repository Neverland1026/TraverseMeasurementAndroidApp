...
//    };
    ...
    public EditText editx1, edity1, editx2, edity2, editx11, edity11, editx22, edity22;
...
//        du = Double.parseDouble(editdu.getText().toString());
//        fen = Double.parseDouble(editfen.getText().toString());
//        miao = Double.parseDouble(editmiao.getText().toString());
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animation shake = AnimationUtils.loadAnimation(
                        TraverseActivity.this, R.anim.shake);
                vibrator.vibrate(50);
                /************************************************************/
//                editx1.setText("123");
//                edity1.setText("123");
...
//                yy = Double.parseDouble(edityy.getText().toString());
                ...
                if (a == 1) {
                    //检查是否有空值
                    if (editx1.getText().toString().equals("") || edity1.getText().toString().equals("") || editx2.getText().toString().equals("") || edity2.getText().toString().equals("")) {
...
//                        editfen1.setText("" + test1.getFen());     保留有用
//                        editdu1.setText((int)Math.floor(test1.getDu()));
...
//                        q = test3.getMiaojian();
                        ...
                        System.out.println("cos="+w*3.1415926/180);
...
//                //1、打开Preferences，名称为traverse，如果存在则打开它，否则创建新的Preferences
//                SharedPreferences traverse = getSharedPreferences("traverse", 0);
//                //2、让traverse处于编辑状态
//                SharedPreferences.Editor editor = traverse.edit();
//                //3、存放数据
//                editor.putString("name", "editxx");
...
//                for (int i = 0; i < 10; i++) {
//                    datainfo.add(new TraverseInfo(System.currentTimeMillis(), random.nextInt(2) + 1, "message body" + i, Long.toString(number + i), i));
//                }
        ...
        btn.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                Intent intent = new Intent(TraverseActivity.this, ResultActivity.class);
...
//                datainfo = new ArrayList<TraverseInfo>();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == android.view.KeyEvent.KEYCODE_BACK) {
            Intent intent = new Intent(TraverseActivity.this, TypeActivity.class);
            startActivity(intent);
            finish();
        }
...
//                serializer.endTag(null, "下一方位角");
//
//                serializer.startTag(null, "增量");
//                serializer.text(main.getIncremental());
//                serializer.endTag(null, "增量");
//
//                serializer.startTag(null, "下一站坐标");
//                serializer.text(main.getCoordinate2());
//                serializer.endTag(null, "下一站坐标");
