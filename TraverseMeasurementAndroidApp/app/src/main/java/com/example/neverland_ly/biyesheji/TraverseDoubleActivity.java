...
public class TraverseDoubleActivity extends AppCompatActivity {
    ...
    /************************************************************/
    public double x1, y1, x2, y2, xc, yc, xd, yd,x11, y11, x22, y22, s, xx, yy;
    public double du1, fen1, miao1, du2, fen2, miao2, du3, fen3, miao3, du4, fen4, miao4;
    public double zz,zzz, tt, o, p, q, w, m, n, mm, nn;
    ...
    public EditText editx1, edity1, editx2, edity2, editx11, edity11, editx22, edity22,editxc, edityc,editxd, edityd;
    public EditText editdu1, editfen1, editmiao1, editdu2, editfen2, editmiao2, editdu3, editfen3, editmiao3, edits;
    public EditText editdu11, editfen11, editmiao11;
    ...
    public double sum_s, sum_x, sum_y, sum_xcd, sum_ycd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_traverse_double);
        ...
        editxd = (EditText) this.findViewById(R.id.kzd_xd);
        edityd = (EditText) this.findViewById(R.id.kzd_yd);
        ...
        editdu11 = (EditText) this.findViewById(R.id.et_du11);
        editfen11 = (EditText) this.findViewById(R.id.et_fen11);
        editmiao11 = (EditText) this.findViewById(R.id.et_miao11);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animation shake = AnimationUtils.loadAnimation(
                        TraverseDoubleActivity.this, R.anim.shake);
                vibrator.vibrate(50);
                /************************************************************/
                if (a == 1) {
                    //检查是否有空值
                    if (editx1.getText().toString().equals("") || edity1.getText().toString().equals("") || editx2.getText().toString().equals("") || edity2.getText().toString().equals("")|| editxc.getText().toString().equals("")|| edityc.getText().toString().equals("")|| editxd.getText().toString().equals("")|| edityd.getText().toString().equals("")) {
                        ...
                        editxd.startAnimation(shake);
                        edityd.startAnimation(shake);
                        vibrator.vibrate(50);
                        ...
                        //获取必要量
                        xc = Double.parseDouble(editxc.getText().toString());
                        yc = Double.parseDouble(edityc.getText().toString());
                        xd = Double.parseDouble(editxd.getText().toString());
                        yd = Double.parseDouble(edityd.getText().toString());
                        //开始计算推算元素
                        sum_xcd = xd - xc;
                        sum_ycd = yd - yc;
                        zuobiaozhengfansuan fss = new zuobiaozhengfansuan();
                        zzz = fss.zbfs_fwj(xc, yc, xd, yd);
//                        sum_s = fss.zbfs_S(xc, yc, xd, yd);
                        Log.i("方位角是：", "" + zzz);
                        jiaoduzhuanhuan test11 = new jiaoduzhuanhuan();
                        test11.miaozhuanjiaodu(zzz);

                        editdu11.setText("" + test11.getDu());
                        editfen11.setText("" + test11.getFen());
                        editmiao11.setText("" + test11.getMiao());
        ...
        btn.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                Intent intent = new Intent(TraverseDoubleActivity.this, ResultActivity.class);
...
//                finish();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == android.view.KeyEvent.KEYCODE_BACK) {
            Intent intent = new Intent(TraverseDoubleActivity.this, TypeActivity.class);
            startActivity(intent);
            finish();
        }
        return true;
